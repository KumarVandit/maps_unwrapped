  ...
  return (
    <WrappedContainer bg="bg-zinc-900" text="text-starship-400">
      ...
      <MutedText className="!text-zinc-200 max-w-xl mx-auto">
        ...
        browser - no need to connect your account to Wrapped!
        Wrapped won't have access to your Spotify data, but simply
        embed the Spotify Player.
        <br />
        <br />
        If you don't have Spotify Premium, you can still fully use Wrapped - just without the music.
      </MutedText>
