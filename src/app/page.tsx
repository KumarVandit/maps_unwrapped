    ...
    <div>
      ...
      {page === "error" && (
        <WrappedContainer>
          ...
          <MutedText>
            We couldn't read your data export. Please make sure you
      ...
      {page === "possibly_empty" && (
        <WrappedContainer>
          ...
          <MutedText className="mx-auto max-w-xl">
            The Google Maps data export you uploaded doesn't contain much data.
            <br />
      ...
      {/* {page === "text" && (
        <WrappedContainer>
          ...
          <MutedText className="max-w-lg mx-auto">
            ...
            file format when requesting your Instagram data export.
      ...
      {page === "unknown_file" && (
        <WrappedContainer>
          ...
          <MutedText className="max-w-lg mx-auto">
            ...
            you select a "folder" or ".zip" file.
            <br />
            If you modified the file, make sure your file has the correct file
            extension i.e. either a .zip file or a extracted folder.
          </MutedText>
          <Button
            onClick={() => {
              setPage("intro");
      ...
      {page === "demo" && (
        <WrappedContainer>
          <FatHeading>Demo Wrapped</FatHeading>
          <MutedText className="max-w-xl mx-auto">
            You can view a demo of Wrapped for Google Maps with sample data if you
            want to.
            <br />
            ...
            <strong>
              ...
              <br />
              It does not use your Google Maps data export. 
            </strong>
            <br />
            <br />
            The data is demo-data and is of a real user - if you want to see your own Wrapped, you can reload
      ...
      {page === "play" && wrapped?.demoMode && !localStorage.getItem("_hide_demo") && (
        <div className="fixed bottom-12 left-12 right-12 z-0 opacity-60 text-zinc-500 break-words">
          ...
          <p className="text-sm">
            This is a demo of Google Maps Wrapped. It does not use your real
            Google Maps data.
            <br />
            To see your own Wrapped, reload the page and upload your own folder/.zip file.
          </p>
        </div>
      )}
    </div>
